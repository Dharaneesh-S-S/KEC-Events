// pages/ClubNotificationsPage.jsx
...
function ClubNotificationsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Navbar
        searchPlaceholder="Search Club Notifications..."
        showSort={false}
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pt-24">
        <div className="mb-8 text-center">
          <h1 className="text-4xl sm:text-5xl font-bold mb-2">Club Notifications</h1>
          <p className="text-xl text-gray-600">
            View your club's recent notifications and updates
          </p>
        </div>
            ...
            <div className="divide-y divide-gray-200">
              {!filteredNotifications.length ? (
                <div className="p-12 text-center">
                  ...
                  <h3 className="text-lg font-medium mb-2">No Club Notifications</h3>
                  <p className="text-gray-500">
                    No club notifications match your search criteria.
                  </p>
                </div>
              ) : (
